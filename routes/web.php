...
// Rota para teste de logos por tema
Route::get('/test-logo-theme', function () {
    $setting = \App\Models\App::first();
    return view('test-logo-theme', compact('setting'));
})->name('test.logo.theme');
...
Route::post('/api/enviar-email-checkout', [ObrigadoController::class, 'enviarEmailCheckout'])->name('api.enviar-email-checkout');

// Rotas para customização de checkout V1
Route::post('/checkout/save-customization', [App\Http\Controllers\User\CheckoutCustomizationController::class, 'saveCustomization'])->name('checkout.save-customization');
Route::get('/checkout/preview/{id}', [App\Http\Controllers\User\CheckoutCustomizationController::class, 'preview'])->name('checkout.preview');
Route::post('/checkout/reset-customization', [App\Http\Controllers\User\CheckoutCustomizationController::class, 'resetCustomization'])->name('checkout.reset-customization');
Route::get('/checkout/export-config/{id}', [App\Http\Controllers\User\CheckoutCustomizationController::class, 'exportConfig'])->name('checkout.export-config');
Route::post('/checkout/import-config', [App\Http\Controllers\User\CheckoutCustomizationController::class, 'importConfig'])->name('checkout.import-config');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/enviar-docs/{id}', [EnviarDocControlller::class, 'enviarDocs'])->where('id', ".*")->name('profile.enviardocs')->middleware('secure.upload');
      ...
      Route::post('/user/avatar-upload', [ProfileController::class, 'uploadAvatar'])->name('profile.avatar.upload')->middleware('secure.upload');
      ...
      Route::group(['prefix' => 'relatorio'], function () {
          ...
          Route::get('/saidas/detalhes/{id}', [RelatoriosControlller::class, 'getSaidaDetails'])->name('profile.relatorio.saidas.detalhes');
    ...
    Route::group(['prefix' => 'produtos'], function () {
        ...
        Route::get('/pedido/detalhes/{id}', [CheckoutControlller::class, 'detalhesPedido'])->name('profile.checkout.pedido.detalhes');
    ...
    // Rotas do Checkout Builder
    Route::get('checkout-builder/{id}', [CheckoutControlller::class, 'checkoutBuilder'])->where('id', '.*')->name('profile.checkout.builder');
    Route::post('checkout-builder/{id}/save', [CheckoutControlller::class, 'saveCheckoutBuilder'])->where('id', '.*')->name('profile.checkout.builder.save');
    ...
    Route::group(['prefix' => env("ADM_ROUTE"), 'middleware'=> 'check.admin'], function () {
        ...
        // Carteira Gateway
        Route::get('/gateway-wallet', [App\Http\Controllers\Admin\GatewayWalletController::class, 'index'])->name('admin.gateway-wallet.index');
        Route::post('/gateway-wallet/sacar', [App\Http\Controllers\Admin\GatewayWalletController::class, 'sacar'])->name('admin.gateway-wallet.sacar');
        Route::post('/gateway-wallet/confirmar/{id}', [App\Http\Controllers\Admin\GatewayWalletController::class, 'confirmarSaque'])->name('admin.gateway-wallet.confirmar');
        Route::post('/gateway-wallet/cancelar/{id}', [App\Http\Controllers\Admin\GatewayWalletController::class, 'cancelarSaque'])->name('admin.gateway-wallet.cancelar');
        Route::post('/gateway-wallet/atualizar-saldo', [App\Http\Controllers\Admin\GatewayWalletController::class, 'atualizarSaldo'])->name('admin.gateway-wallet.atualizar-saldo');
        
        // Splits Internos
        Route::get('/splits-internos', [App\Http\Controllers\Admin\SplitInternosController::class, 'index'])->name('admin.splits-internos.index');
        Route::get('/splits-internos/create', [App\Http\Controllers\Admin\SplitInternosController::class, 'create'])->name('admin.splits-internos.create');
        Route::post('/splits-internos', [App\Http\Controllers\Admin\SplitInternosController::class, 'store'])->name('admin.splits-internos.store');
        Route::post('/splits-internos/processar-gateway', [App\Http\Controllers\Admin\SplitInternosController::class, 'processarSplitsGateway'])->name('admin.splits-internos.processar-gateway');
        ...
        Route::group(['prefix' => 'financeiro'], function () {
            ...
            Route::get('/saidas/detalhes/{id}', [App\Http\Controllers\Admin\Financeiro\SaidasController::class, 'getSaidaDetails'])->name('admin.financeiro.saidas.detalhes');
        ...
        Route::group(['prefix' => 'ajustes'], function () {
            ...
            Route::post('/rede', [App\Http\Controllers\Admin\Ajustes\AdquirentesController::class, 'updateRede'])->name('admin.adquirentes.rede');
            Route::post('/stripe', [App\Http\Controllers\Admin\Ajustes\AdquirentesController::class, 'updateStripe'])->name('admin.adquirentes.stripe');
            Route::post('/xdpag', [App\Http\Controllers\Admin\Ajustes\AdquirentesController::class, 'updateXDPag'])->name('admin.adquirentes.xdpag');
            Route::post('/trustypix', [App\Http\Controllers\Admin\Ajustes\AdquirentesController::class, 'updateTrustyPix'])->name('admin.adquirentes.trustypix');
            ...
            // Rotas SMTP
            Route::get('/smtp', [App\Http\Controllers\Admin\Ajustes\SmtpController::class, 'index'])->name('admin.smtp.index');
            Route::post('/smtp', [App\Http\Controllers\Admin\Ajustes\SmtpController::class, 'update'])->name('admin.smtp.update');
            Route::post('/smtp/test', [App\Http\Controllers\Admin\Ajustes\SmtpController::class, 'testEmail'])->name('admin.smtp.test');
            ...
            Route::group(['prefix' => 'splits-internos'], function () {
                ...
                Route::get('/{splitInterno}/edit', [App\Http\Controllers\Admin\SplitInternosController::class, 'edit'])->name('admin.splits-internos.edit');
                Route::put('/{splitInterno}', [App\Http\Controllers\Admin\SplitInternosController::class, 'update'])->name('admin.splits-internos.update');
                Route::post('/{splitInterno}/update', [App\Http\Controllers\Admin\SplitInternosController::class, 'update'])->name('admin.splits-internos.update-post');
...
Route::post('/checkout/webhook', [CheckoutControlller::class, 'pagarmeWebhook'])->name('checkout.webhook.pagarme');
...
// Rotas do Sistema de Upsell
Route::group(['prefix' => 'api/upsell'], function () {
    Route::post('/process', [App\Http\Controllers\Api\UpsellController::class, 'process'])->name('api.upsell.process');
    Route::get('/produto/{id}', [App\Http\Controllers\Api\UpsellController::class, 'getProduto'])->name('api.upsell.produto');
});
