...
class EntradasController extends Controller
{
    public function index(Request $request)
    {
        ...
        $totalRecords = Solicitacoes::whereIn('status', ['RELEASE', 'PAID_OUT', 'CANCELED', 'WAITING_FOR_APPROVAL', 'MEDIATION']);
        ...
        $cashOutsQuery = Solicitacoes::whereIn('status', ['RELEASE', 'PAID_OUT', 'CANCELED', 'WAITING_FOR_APPROVAL', 'MEDIATION']);
