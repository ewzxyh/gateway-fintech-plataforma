        ...
        try {
            ...
            switch ($default) {
                ...
                case 'mercadopago':
                    ...
                    break;
                case 'pagarme':
                    $response = PagarMeTrait::requestPaymentPagarme($request);
                    break;
                case 'efi':
                ...
                case 'primepay7':
                    ...
                    break;
                case 'rede':
                    $response = \App\Traits\RedeTrait::requestPaymentRede($request);
                    break;
                case 'xdpag':
                    $response = XDPagTrait::requestPaymentXDPag($request);
                    break;
                case 'trustypix':
                    $response = TrustyPixTrait::requestPaymentTrustyPix($request);
                    break;
                default:
