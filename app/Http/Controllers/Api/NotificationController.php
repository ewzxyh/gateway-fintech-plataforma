...
class NotificationController extends Controller
{
    ...
    {
        try {
            AppRequestLogger::logAppRequest('POST', 'notifications/register-token', 'unknown', $request->all());
            ...
            if ($validator->fails()) {
                AppRequestLogger::logAppRequestError('POST', 'notifications/register-token', 'unknown', 'Dados inválidos: ' . $validator->errors()->first(), $request->all());
            ...
            if (!$user) {
                AppRequestLogger::logAppRequestError('POST', 'notifications/register-token', 'unknown', 'Usuário não autenticado', $request->all());
                return response()->json([
                    'success' => false,
