...
class DepositController extends Controller
{
    ...
    public function makeDeposit(Request $request)
    {
        ...
        $default = Helper::adquirenteDefault($user->username);
        ...
        try {
            $validated = $request->validate([
                ...
                'split_username' => ['nullable', 'string'],
        ...
        switch($default){
            ...
            break;
            case 'trustypix':
                \Log::info('DepositController - Executando TrustyPixTrait', []);
                $response = TrustyPixTrait::requestDepositTrustyPix($request);
            break;
            default:
