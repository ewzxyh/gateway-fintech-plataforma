...
class TaxaSaqueHelper
{
    ...
    public static function calcularTaxaSaque($amount, $setting, $user, $isInterfaceWeb = false, $taxaPorFora = false)
    {
        ...
        // === CARTEIRA GATEWAY NÃO PAGA TAXA ===
        // A carteira gateway não deve pagar taxa de saque pois é o próprio sistema
        if ($user && $user->user_id === 'gateway_wallet') {
            \Log::info('TaxaSaqueHelper: Saque da carteira gateway - taxa zerada', [
            ...
            return [
                ...
                'descricao' => 'CARTEIRA_GATEWAY_SEM_TAXA',
