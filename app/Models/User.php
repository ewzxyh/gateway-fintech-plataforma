...
class User extends Authenticatable
{
    ...
    /**
     * Accessor para sempre retornar o username com @ na frente
     */
    public function getUsernameAttribute($value)
    {
        // Se o username já começar com @, retorna como está
        if (str_starts_with($value, '@')) {
            return $value;
        }
        
        // Caso contrário, adiciona @ na frente
        return '@' . $value;
    }

    /**
     * Accessor para retornar o username original (sem @)
     */
    public function getOriginalUsernameAttribute()
    {
        $username = $this->getRawOriginal('username');
        return str_starts_with($username, '@') ? substr($username, 1) : $username;
    }
}
